...
public partial class PetShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbService>(entity =>
        {
            ...
            entity.HasOne(d => d.CategoryService).WithMany(p => p.TbServices)
                .HasForeignKey(d => d.CategoryServiceId)
                .HasConstraintName("FK_tb_Service_tb_ServiceCategory");
        });
        ...
        modelBuilder.Entity<TbServiceCategory>(entity =>
        {
            ...
            entity.ToTable("tb_ServiceCategory");
        ...
        modelBuilder.Entity<TbServiceReview>(entity =>
        {
            entity.HasKey(e => e.ProductServiceId);

            entity.ToTable("tb_ServiceReview");
            ...
            entity.HasOne(d => d.Service).WithMany(p => p.TbServiceReviews)
                .HasForeignKey(d => d.ServiceId)
                .HasConstraintName("FK_tb_ServiceReview_tb_Service");
        });
