...
namespace PetShop.Areas.Admin.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        {
            var petShopContext = _context.TbAccounts.Include(t => t.Role);
        ...
        public async Task<IActionResult> Create([Bind("AccountId,Username,Password,Avatar,FullName,Birthday,Phone,Address,Email,RoleId,Position,LastLogin,IsActive")] TbAccount tbAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,Username,Password,Avatar,FullName,Birthday,Phone,Address,Email,RoleId,Position,LastLogin,IsActive")] TbAccount tbAccount)
        {
