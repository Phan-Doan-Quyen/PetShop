...
{
    [Area("Admin")]
    [Route("/Admin/el-finder-blog-file-system")]
    public class BlogFileSystemController : Controller
    {
        IWebHostEnvironment _env;
        public BlogFileSystemController(IWebHostEnvironment env) => _env = env;
        ...
        private Connector GetConnector()
        {
            ...
            // https://localhost:5001/blogfiles/
            string url = $"/{pathroot}/";
            string urlthumb = $"{uri.Scheme}://Admin/el-finder-blog-file-system/thumb/";
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                Alias = "Blog-Files", // Beautiful name given to the root/home folder
